...
INSERT INTO schedule_job (bean_name, params, cron_expression, status, remark, create_time) VALUES ('captchaCleanTask', '', '0 /10 * * * ?', '0', '验证码清理定时器，每10分钟执行一次', '2016-12-01 23:16:46');
